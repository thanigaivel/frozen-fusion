...
export async function POST(request: Request) {
  try {
    ...
    // 2. Send Email via Nodemailer to support@frozenfusion.in
...
`,
            ...
            <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #0b0c10; color: #ffffff; border-radius: 16px; overflow: hidden; border: 1px solid #232733;">
              ...
              <div style="padding: 28px 24px;">
                <div style="background: rgba(255, 255, 255, 0.04); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 12px; padding: 20px; margin-bottom: 24px;">
                  <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                      ...
                      <td style="padding: 8px 0; color: #FF6BD6; font-size: 14px; font-weight: 600;">${subject || "General Inquiry"}</td>
                    </tr>
                    <tr>
                ...
                <div style="padding-top: 16px; border-top: 1px solid rgba(255, 255, 255, 0.08); text-align: center;">
                  <a href="mailto:${email}?subject=Re: ${encodeURIComponent(subject || 'General Inquiry')} - Frozen Fusion" style="display: inline-block; background: #FF6BD6; color: #ffffff; padding: 10px 24px; border-radius: 50px; text-decoration: none; font-weight: 600; font-size: 13px;">
                    Reply to ${name}
                  </a>
        ...
        console.log(`[CONTACT API] Email successfully sent to support@frozenfusion.in for ${name} (${email})`);
      } catch (emailErr) {
