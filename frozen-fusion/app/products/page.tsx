...
function Stars({ rating }: { rating: number }) {
  return (
    <span className="flex items-center gap-0.5 text-amber-400">
      ...
      <span className="ml-1 text-white/40 text-[10px] font-inter">
        {rating.toFixed(1)}
      </span>
    </span>
  );
...
const BADGE_STYLES: Record<string, string> = {
  "Best Seller":
    "from-amber-500/80 to-orange-600/80 border-amber-400/40 text-amber-100",

  New:
    "from-emerald-500/80 to-teal-600/80 border-emerald-400/40 text-emerald-100",

  Limited:
    "from-violet-500/80 to-purple-600/80 border-violet-400/40 text-violet-100",

  Popular:
    "from-pink-500/80 to-rose-600/80 border-pink-400/40 text-pink-100",

  Seasonal:
    "from-sky-500/80 to-blue-600/80 border-sky-400/40 text-sky-100",
};

function BadgePill({ badge }: { badge: string }) {
  const style =
    BADGE_STYLES[badge] ||
    "from-gray-500/80 to-gray-600/80 border-gray-400/40 text-gray-100";

  return (
    <span
      className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-gradient-to-r border ${style} backdrop-blur-sm`}
    >
      {badge}
    </span>
  );
    ...
    >
      ...
      >
        <div className="flex items-start gap-3 md:gap-4 flex-1 min-w-0">
          <span className="text-3xl md:text-4xl shrink-0 pt-1">
            {category.icon}
          </span>
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-white/40 font-inter text-xs md:text-sm mt-0.5 leading-relaxed">
      ...
      <div
        ref={scrollRef}
        className="flex gap-4 overflow-x-auto pt-2 pb-3 overflow-y-hidden scrollbar-hide"
        style={{
          scrollbarWidth: "none",
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(600px circle at 50% 50%, ${glow} 0%, transparent 70%)`,
        }}
      />
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: `0 0 70px ${glow}, 0 40px 80px rgba(0,0,0,0.8)`,
        }}
        onClick={(e) =>
          e.stopPropagation()
        }
        ...
        <div className="flex flex-wrap items-center gap-3 mb-3">
          <div className="flex flex-wrap gap-2">
            {FILTERS.map((f) => {
              ...
              const label = isFavFilter
                ? `❤️ Favourites ${favoritesCount > 0
                  ? `(${favoritesCount})`
                  : ""
                }`
                : f;
              ...
              return (
                <motion.button
                  ...
                  className="px-4 py-1.5 rounded-full text-xs font-semibold font-inter uppercase tracking-wide transition-all duration-200 flex items-center gap-1"
                  style={
                    active === f
                      ? {
                        background:
                          "linear-gradient(135deg, #FF6BD6, #8B5CF6)",
                        color: "#fff",
                        border:
                          "1px solid transparent",
                        boxShadow:
                          "0 0 16px rgba(255,107,214,0.35)",
                      }
                      : {
                        background:
                          "rgba(255,255,255,0.05)",
            ...
            <button
              ...
              style={
                activeCategory === cat.id
                  ? {
                    background: `${cat.headerColor}20`,
                    color:
                      cat.headerColor,
                    border: `1px solid ${cat.headerColor}40`,
                  }
                  : {
                    background:
                      "transparent",
      ...
      (
        ...
        setFavorites((prev) => {
          ...
          if (productName) {
            setToast({
              message: isFav
                ? `Removed ${productName} from favourites`
                : `❤️ Added ${productName} to favourites!`,
              visible: true,
            });
      ...
      <section className="relative pt-36 pb-14 px-6 overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(255,43,194,0.08) 0%, transparent 70%)",
            }}
          />

          <div
            className="absolute top-10 right-1/4 w-[400px] h-[400px] rounded-full blur-[100px]"
            style={{
              background:
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          <motion.div
            ...
            style={{
              background:
                "rgba(255,43,194,0.1)",
              border:
                "1px solid rgba(255,43,194,0.25)",
              color: "#FF6BD6",
            }}
          >
            🍦{" "}
            {totalFlavours > 0
              ? `${totalFlavours}+ Premium Flavours`
          ...
          <motion.h1
            ...
            style={{
              background:
                "linear-gradient(135deg, #ffffff 0%, #FF6BD6 40%, #FFB347 100%)",
              WebkitBackgroundClip:
                "text",
              WebkitTextFillColor:
                "transparent",
              backgroundClip:
                "text",
              filter:
                "drop-shadow(0 0 35px rgba(255,107,214,0.3))",
            }}
          >
            OUR MENU
          </motion.h1>
          ...
          >
            ...
            100+ premium dessert
            flavours — from rich
            kulfi to exotic fusion
            drinks, each crafted to
            perfection.
          </motion.p>
          ...
          >
            {[
              ...
              ({
                ...
                >
                  <p className="text-2xl font-bold font-inter text-white">
                    {value}
                  </p>

                  <p className="text-white/40 text-xs font-inter uppercase tracking-widest">
                    {label}
                  </p>
                </div>
              )
      ...
      <div className="flex-1 px-6 max-w-[1400px] mx-auto w-full pb-24">
        {loadingProducts ? (
          <div className="flex flex-col items-center justify-center py-32 gap-4">
            ...
            <p className="text-white/50 font-inter text-sm tracking-widest uppercase">
              Loading Menu...
            </p>
          </div>
          ...
          >
            ...
            <p className="text-white/50 font-inter text-xl mb-2">
              {activeFilter ===
                "Favourites"
                ? "No favourite flavours saved yet"
                : "No flavours found"}
            </p>
        ...
        {toast?.visible && (
          <motion.div
            ...
            style={{
              ...
              boxShadow:
                "0 10px 40px rgba(0,0,0,0.5), 0 0 20px rgba(255,107,214,0.3)",
            }}
          >
            <span>
              {toast.message}
